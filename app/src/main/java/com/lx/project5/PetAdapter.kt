...
import com.lx.project5.databinding.FragmentDogItemBinding
...
class PetAdapter : RecyclerView.Adapter<PetAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent : ViewGroup, viewType:Int): PetAdapter.ViewHolder{
        val binding = FragmentDogItemBinding.inflate(LayoutInflater.from(parent.context),parent, false)
    ...
    inner class ViewHolder(val binding: FragmentDogItemBinding):RecyclerView.ViewHolder(binding.root){
        //데이터 설정
