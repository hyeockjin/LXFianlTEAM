...
class Write2Fragment : Fragment(),DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    override fun onTimeSet(view: TimePicker?, hourOfDay: Int, Minute: Int) {
        ...
        if (cIndex == 1){
            ...
            Log.v("@@","${hour},@@${minute}")
            binding.editTextTime3.text = "$savedYear-$savedMonth-$savedDay $savedHour:$savedMinute"
            ...
            Log.v("@@","${hour},@@${minute}")
            binding.editTextTime4.text = "$savedYear-$savedMonth-$savedDay $savedHour:$savedMinute"
        }
